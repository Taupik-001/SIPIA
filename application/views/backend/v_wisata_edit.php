        ...
        <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
                ...
                foreach ($wisata as $s) { ?>
                    ...
                    <form action="<?= base_url('wisata/edit_action'); ?> " method="post" id="form-satuan" enctype="multipart/form-data">
                        <table class="table table-striped ">
                            ...
                            <tr>
                                <td>Nama Wisata</td>
                                <td><input type="text" class="form-control" name="nama_wisata" required="required" value="<?= $s->nama_wisata ?>"></td>
                            </tr>

                            <tr>
                                <td>Kategori Wisata</td>
                                <td><select class="form-control" name="jenis_wisata" id="jenis_wisata" required="">
                                        <option value="">Pilih</option>
                                        <?php foreach ($wisata_jenis as $row) {
                                            if ($row->id == $s->jenis_wisata) { ?>
                                                <option value="<?= $row->id; ?>" selected=selected><?= $row->id . ' - ' . $row->jenis_wisata; ?></option>
                                            <?php

                                            } else {
                                            ?>
                                                <option value="<?= $row->id; ?>"><?= $row->id . ' - ' . $row->jenis_wisata; ?></option>
                                        <?php }
                                        } ?>
                                    </select>
                                </td>
                            ...
                            <tr>
                                <td>Harga Tiket</td>
                                <td>
                                    <textarea type="text" class="form-control" name="harga_tiket" required="required" value=""><?= $s->harga_tiket ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>Jam Buka</td>
                                <td><input type="time" class="form-control" name="jam_buka" required="required" value="<?= $s->jam_buka ?>"></td>
                            </tr>
                            <tr>
                                <td>Jam Tutup</td>
                                <td><input type="time" class="form-control" name="jam_tutup" required="required" value="<?= $s->jam_tutup ?>"></td>
                            </tr>
                            <tr>
                                <td>Alamat</td>
                            ...
                            <tr>
                                <td></td>
                                <td><img src="<?= base_url('assets/images/wisata/'); ?><?= $s->foto ?>" alt="" width="200"></td>
                            </tr>
                            </tr>
