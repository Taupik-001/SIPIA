        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview active">
                ...
                <ul class="treeview-menu">
                    <li class="active"><a href="<?php echo base_url() . 'provinsi'; ?>"><i class="fa fa-circle-o"></i>Provinsi</a></li>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="<?= base_url('provinsi'); ?>">Provinsi</a></li>
        </ol>
    </section>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('provinsi/edit/') . $s->id; ?>"><button class="btn btn-primary">Edit</button></a>
                                            <a href="<?= base_url('provinsi/hapus/') . $s->id; ?>"><button class="btn btn-danger">Hapus</button></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
