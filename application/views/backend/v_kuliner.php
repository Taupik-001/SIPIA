...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active"><a href="<?php echo base_url() . 'kuliner'; ?>"><i class="fa fa-cutlery"></i> <span>Kuliner</span></a></li>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="<?= base_url('kuliner'); ?>">Kuliner</a></li>
        </ol>
    </section>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <h2> DATA kuliner </h2>
                            <a href="<?= base_url('kuliner/input'); ?>"><button class="btn btn-warning">Input kuliner</button></a>
                            <hr>
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="<?= base_url('assets/images/kuliner/'); ?><?= $s->foto ?>" alt="" width="100" height="60">
                                        </td>
                                        ...
                                        <td>
                                            <a href="<?= base_url('kuliner/edit/') . $s->id; ?>"><button class="btn btn-primary">Edit</button></a>
                                            <a href="<?= base_url('kuliner/hapus/') . $s->id; ?>"><button class="btn btn-danger">Hapus</button></a>
