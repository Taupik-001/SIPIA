        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview active">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="active"><a href="<?php echo base_url() . 'kabupaten_kota/kota'; ?>"><i class="fa fa-circle-o"></i>Kota</a></li>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="<?= base_url('kabupaten_kota'); ?>">Kota</a></li>
        </ol>
    </section>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <h2> DATA KOTA </h2>
                            <a href="<?= base_url('kabupaten_kota/input'); ?>"><button class="btn btn-warning">Input Kota</button></a>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <img src="<?= base_url('assets/images/kabupaten_kota/'); ?><?= $s->foto ?>" alt="" width='60' height='63'>
                                        </td>
