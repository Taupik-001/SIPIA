        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview active">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="active"><a href="<?php echo base_url() . 'user'; ?>"><i class="fa fa-circle-o"></i>Pengguna</a></li>
                </ul>
            </li>
        </ul>
    </section>
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <h2> DATA USER </h2>
                    <a href="<?= base_url('user/input/'); ?>"><button class="btn btn-warning">Input User</button></a>
                    <hr>
                    <thead>
                        <tr>
                            <th>No</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $s->no_telp ?></td>
                                <td>
                                    <a href="<?= base_url('user/edit/'). $s->id; ?>"><button class="btn btn-primary">Edit</button></a>
                                    <a href="<?= base_url('user/hapus/'). $s->id; ?>"><button class="btn btn-danger">Hapus</button></a>
                                    </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
