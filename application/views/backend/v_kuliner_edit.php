        ...
        <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
                ...
                foreach ($kuliner as $s) { ?>
                    ...
                    <form action="<?= base_url('kuliner/edit_action'); ?> " method="post" id="form-satuan" enctype="multipart/form-data">
                        <table class="table table-striped ">
                            ...
                            <tr>
                                <td>Nama Kuliner : </td>
                                <td><input type="text" class="form-control" name="nama_kuliner" required="required" value="<?= $s->nama_kuliner ?>"></td>
                            </tr>

                            <tr>
                                <td>Jenis Kuliner : </td>
                                <td><input type="text" class="form-control" name="jenis_kuliner" required="required" value="<?= $s->jenis_kuliner ?>"></td>
                            </tr>

                            <tr>
                                <td>Harga Kuliner : </td>
                                <td>
                                    <textarea type="text" class="form-control" name="harga" required="required" value=""><?= $s->harga ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>Alamat : </td>
                            ...
                            <tr>
                                <td></td>
                                <td><img src="<?= base_url('assets/images/kuliner/'); ?><?= $s->foto ?>" alt="" width="200"></td>
                            </tr>
                            </tr>
