...
<section class="py-5 text-center container">
    <div class="row">
        <div class="col-lg-6 col-md-8 mx-auto">
            <h1 class="fw-light">Artikel Hotel</h1>
            ...
            <div class="col">
                <div class="card shadow-sm">
                    <a href="" class="text-thumbail">
                        <img class="bd-placeholder-img card-img-top" width="100%" height="300" src="<?= base_url('assets/images/hotel/'); ?><?= $w->foto ?>" role="img" preserveAspectRatio="xMidYMid slice" focusable="false">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                                <a href="<?= base_url('artikel/hotel/') . $w->url; ?>">
